...
const translations = {
    en: {
        ...
        'skills.skill2desc': 'Dynamic motion design and visual effects that capture attention. Animations that bring ideas to life.',
        ...
        'skills.skill7desc': 'UI/UX design for intuitive and modern user interfaces. From wireframes to interactive prototypes.',
        'skills.skill8desc': 'Clean, well-structured HTML and modern, responsive CSS. Layouts that work seamlessly across all devices.',
        'skills.skill9desc': 'Interactive features and dynamic content for modern websites. Logic that enhances design and user experience.',
